...
export abstract class IQuery {
  abstract libraryItems():
    | LibraryItemMetadata[]
    | Promise<LibraryItemMetadata[]>;

  abstract libraryItem(
    id: string,
  ): Nullable<LibraryItemMetadata> | Promise<Nullable<LibraryItemMetadata>>;

  abstract itemArchives(itemId: string): ItemArchive[] | Promise<ItemArchive[]>;

  abstract chunkEmbedGroups(
    itemId: string,
  ):
    | Nullable<Nullable<ChunkEmbedGroups>[]>
    | Promise<Nullable<Nullable<ChunkEmbedGroups>[]>>;

  abstract signedUploadUrl(
    request: RegisterPdfUploadUrlRequest,
  ): Nullable<SignedS3UploadResult> | Promise<Nullable<SignedS3UploadResult>>;

  abstract semanticSearch(
    query: string,
    chunkEmbedGroupId: string,
    topK?: Nullable<number>,
    scoreThreshold?: Nullable<number>,
    filters?: Nullable<SemanticSearchFilters>,
  ): Nullable<SemanticSearchResult> | Promise<Nullable<SemanticSearchResult>>;
}

export abstract class IMutation {
  abstract createLibraryItem(
    title: string,
  ): Nullable<LibraryItemMetadata> | Promise<Nullable<LibraryItemMetadata>>;

  abstract createChunkEmbedGroup(
    input: CreateChunkEmbedGroupInput,
  ): Nullable<ChunkEmbedGroup> | Promise<Nullable<ChunkEmbedGroup>>;
}
