...
export const ProviderSettingsKeyMap: Record<
  DisplayKeyProviders,
  keyof CopilotSettings
> = {
...
export const COMMAND_NAMES: Record<CommandId, string> = {
  ...
  [COMMAND_IDS.COUNT_WORD_AND_TOKENS_SELECTION]:
  ...
  [COMMAND_IDS.INSPECT_COPILOT_INDEX_BY_NOTE_PATHS]:
    'Inspect Copilot index by note paths (debug)',
  [COMMAND_IDS.LIST_INDEXED_FILES]: 'List all indexed files (debug)',
  [COMMAND_IDS.LOAD_COPILOT_CHAT_CONVERSATION]:
    'Load Copilot chat conversation',
  ...
  [COMMAND_IDS.REMOVE_FILES_FROM_COPILOT_INDEX]:
    'Remove files from Copilot index (debug)',
...
export const DEFAULT_SETTINGS: CopilotSettings = {
  ...
  embeddingModelKey:
    EmbeddingModels.OPENAI_EMBEDDING_SMALL +
    '|' +
