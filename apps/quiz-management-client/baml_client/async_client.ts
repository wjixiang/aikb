    ...
    env?: Record<string, string | undefined>
      tags?: Record<string, string>
        ...
        __baml_options__?: BamlCallOptions
          ...
          parsedQuestionText,parsedAnswerText,chunkNum,
          __baml_options__
          );
        ...
        __baml_options__?: BamlCallOptions
          ...
          const env: Record<string, string> = Object.fromEntries(
            ...
            __baml_options__?: BamlCallOptions
              ...
              console.error("Error in onTick callback for ConvertToA3Quiz", error);
              }
              }
              };
              }
            ...
            __baml_options__?: BamlCallOptions
              ...
              console.error("Error in onTick callback for ConvertToBQuiz", error);
              }
              }
              };
              }
            ...
            __baml_options__?: BamlCallOptions
              ...
              console.error("Error in onTick callback for ConvertToBasicQuiz", error);
              }
              }
              };
              }
            ...
            input: types.SplitText,
            __baml_options__?: BamlCallOptions
            ): BamlStream<partial_types.QuestionAnswerSlice[], types.QuestionAnswerSlice[]>
              {
              try {
              const options = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const signal = options.signal;
              ...
              console.error("Error in onTick callback for MatchQuestionsAnswers", error);
              }
              }
              };
              }
              ...
              const env: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.QuestionAnswerSlice[], types.QuestionAnswerSlice[]>(
                  raw,
            ...
            input: types.SplitText,
            __baml_options__?: BamlCallOptions
            ): BamlStream<partial_types.QuestionAnswerWithExplanationSlice[], types.QuestionAnswerWithExplanationSlice[]>
              {
              try {
              const options = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const signal = options.signal;
              ...
              console.error("Error in onTick callback for MatchQuestionsAnswersWithExplanation", error);
              }
              }
              };
              }
              ...
              const env: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.QuestionAnswerWithExplanationSlice[], types.QuestionAnswerWithExplanationSlice[]>(
                  raw,
            ...
            __baml_options__?: BamlCallOptions
              ...
              console.error("Error in onTick callback for SplitQuestions", error);
              }
              }
              };
              }
