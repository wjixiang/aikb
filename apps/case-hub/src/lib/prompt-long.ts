...
export function generatePart1(params: {
    ...
    const { department, disease, diseaseInfo, age, gender } = params;
...
病情陈述者:患者本人   入院方式:步行/轮椅
主诉：XXX（症状+时间）
现病史：患者自XX年XX月XX日（详细描述发病过程，至少200字，包括诊疗经过、病情变化、伴随症状、一般情况）
...
参考格式（必须遵循）：
既往史：患者既往体健/有XXX病史...否认高血压、糖尿病、冠心病史，否认肝炎、结核病史，否认手术外伤史，否认食物药物过敏史...
个人史：出生湖南省，久居本地，否认血吸虫疫水接触史，吸烟XX年/否认吸烟史，饮酒XX年/否认饮酒史...
婚姻生育史:已婚，适龄结婚，子女体健...
