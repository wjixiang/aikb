...
class NotificationStream<PartialT, FinalT>
  implements BamlStream<PartialT, FinalT>
{
...
type StreamHandler<PartialT, FinalT> = (
  event: VarNotification<BamlStream<PartialT, FinalT>>,
) => void;
