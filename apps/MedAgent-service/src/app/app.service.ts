...
import { TaskInfo, TaskStatus, CreateTaskInput, StartTaskResult, StartTaskInput, ApiMessage } from '../graphql';
...
export class AppService {
     ...
     */
    async startTask(input: StartTaskInput, context: any): Promise<StartTaskResult> {
