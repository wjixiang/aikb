// npx vitest run sllm-shared/__tests__/getApiMetrics.spec.ts

import type { ClineMessage } from 'llm-types';
...
describe('getApiMetrics', () => {
  ...
  describe('Context tokens calculation', () => {
    it('should calculate contextTokens from the last api_req_started message', () => {
      const messages: ClineMessage[] = [
        createApiReqStartedMessage(
          '{"tokensIn":100,"tokensOut":200,"cacheWrites":5,"cacheReads":10}',
          1000,
        ),
        createApiReqStartedMessage(
          '{"tokensIn":50,"tokensOut":150,"cacheWrites":3,"cacheReads":7}',
          2000,
        ),
      ];
    ...
    it('should handle missing values when calculating contextTokens', () => {
      ...
      const messages: ClineMessage[] = [
        createApiReqStartedMessage(
          '{"tokensIn":null,"cacheWrites":5,"cacheReads":10}',
          1000,
        ),
      ];
