...
export const rooCodeEventsSchema = z.object({
  ...
  [RooCodeEventName.TaskToolFailed]: z.tuple([
    z.string(),
    toolNamesSchema,
    z.string(),
  ]),
  [RooCodeEventName.TaskTokenUsageUpdated]: z.tuple([
    z.string(),
    tokenUsageSchema,
    toolUsageSchema,
  ]),
...
export const taskEventSchema = z.discriminatedUnion('eventName', [
  ...
  z.object({
    ...
    payload:
      rooCodeEventsSchema.shape[RooCodeEventName.TaskDelegationCompleted],
    taskId: z.number().optional(),
  }),
  z.object({
