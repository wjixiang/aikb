...
import { listLocalFiles } from '../lib/local-storage.js';

// Load environment variables
config();

/**
 * Main function to sync local baseline data to database for a specified year
 */
async function main() {
    ...
    console.log(`Starting sync of local baseline data to database for year ${year}...`);
    console.log('========================================');
