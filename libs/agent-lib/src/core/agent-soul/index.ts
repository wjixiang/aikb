...
// 独立模块 Agents
export { createEpidemiologyAgentSoul, createAgentSoul as createEpidemiologyAgentSoulAlias } from './epidemiology/index.js';
export { createPathophysiologyAgentSoul, createAgentSoul as createPathophysiologyAgentSoulAlias } from './pathophysiology/index.js';
export { createDiagnosisAgentSoul, createAgentSoul as createDiagnosisAgentSoulAlias } from './diagnosis/index.js';
export { createManagementAgentSoul, createAgentSoul as createManagementAgentSoulAlias } from './management/index.js';
export { createQualityOfLifeAgentSoul, createAgentSoul as createQualityOfLifeAgentSoulAlias } from './quality-of-life/index.js';
export { createEmergingTreatmentsAgentSoul, createAgentSoul as createEmergingTreatmentsAgentSoulAlias } from './emerging-treatments/index.js';
...
const agentSoulFactories: Record<AgentSoulType, () => AgentFactoryOptions> = {
 ...
 */
export function createAgentSoulByType(type: AgentSoulType): AgentFactoryOptions {
