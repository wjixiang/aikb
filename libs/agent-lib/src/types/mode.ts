...
export const customModePromptsSchema = z.record(
  z.string(),
  promptComponentSchema.optional(),
);
...
export const customSupportPromptsSchema = z.record(
  z.string(),
  z.string().optional(),
);
