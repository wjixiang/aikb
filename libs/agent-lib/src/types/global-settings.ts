...
export const rooCodeSettingsSchema =
  providerSettingsSchema.merge(globalSettingsSchema);
...
export type SecretState = Pick<
  ProviderSettings,
  Extract<ProviderSecretKey, keyof ProviderSettings>
> & {
...
/**
 * Custom support prompts type for user-defined prompt templates
 */
