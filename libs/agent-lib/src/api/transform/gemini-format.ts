...
function isThoughtSignatureContentBlock(
  block: ExtendedContentBlockParam,
): block is ThoughtSignatureContentBlock {
...
export function convertAnthropicContentToGemini(
  ...
  if (Array.isArray(content)) {
    const sigBlock = content.find((block) =>
      isThoughtSignatureContentBlock(block),
    ) as ThoughtSignatureContentBlock;
