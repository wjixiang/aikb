...
import { unboundDefaultModelId, unboundDefaultModelInfo } from '../../types';
...
type UnboundChatCompletionCreateParamsStreaming =
...
type UnboundChatCompletionCreateParamsNonStreaming =
  ...
  implements SingleCompletionHandler
{
  ...
  override getModel() {
    ...
    const info = modelExists
      ? this.models[requestedId]
  ...
  override async *createMessage(
    ...
    if (
      modelId.startsWith('vertex-ai/google.') ||
      modelId.startsWith('vertex-ai/anthropic.')
    ) {
