...
import { VirtualWorkspace, ComponentRegistration } from 'agent-lib';
import { BookViewerComponent, WorkspaceInfoComponent, KnowledgeManageComponent } from 'agent-components';
