...
describe('FireworksHandler', () => {
  ...
  it('should return default model when no model is specified', () => {
    ...
    expect(model.info).toEqual(
      expect.objectContaining(fireworksModels[fireworksDefaultModelId]),
    );
  });

  it('should return specified model when valid model is provided', () => {
    const testModelId: FireworksModelId =
    ...
    expect(model.info).toEqual(
      expect.objectContaining(fireworksModels[testModelId]),
    );
  });
  ...
  it('should return DeepSeek R1 model with correct configuration', () => {
    ...
    expect(model.info).toEqual(
      expect.objectContaining({
        ...
        outputPrice: 8,
        description: expect.stringContaining(
          '05/28 updated checkpoint of Deepseek R1',
        ),
      }),
    );
  });
  ...
  it('should return GLM-4.5 model with correct configuration', () => {
    ...
    expect(model.info).toEqual(
      expect.objectContaining({
        ...
        outputPrice: 2.19,
        description: expect.stringContaining(
          'Z.ai GLM-4.5 with 355B total parameters',
        ),
      }),
    );
  });
  ...
  it('should return GLM-4.5-Air model with correct configuration', () => {
    ...
    expect(model.info).toEqual(
      expect.objectContaining({
        ...
        outputPrice: 2.19,
        description: expect.stringContaining(
          'Z.ai GLM-4.5-Air with 106B total parameters',
        ),
      }),
    );
  });
  ...
  it('should return GLM-4.6 model with correct configuration', () => {
    ...
    expect(model.info).toEqual(
      expect.objectContaining({
        ...
        outputPrice: 2.19,
        description: expect.stringContaining(
          'Z.ai GLM-4.6 is an advanced coding model',
        ),
      }),
    );
  });
  ...
  it('createMessage should pass correct parameters to Fireworks client', async () => {
    const modelId: FireworksModelId =
      'accounts/fireworks/models/kimi-k2-instruct';
    ...
    const messages: Anthropic.Messages.MessageParam[] = [
      { role: 'user', content: 'Test message for Fireworks' },
    ];
