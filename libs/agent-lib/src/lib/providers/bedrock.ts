...
export const bedrockDefaultPromptRouterModelId: BedrockModelId =
...
export const bedrockModels = {
  ...
  'moonshot.kimi-k2-thinking': {
    ...
    outputPrice: 2.5,
    description:
      'Kimi K2 Thinking (1T parameter MoE model with 32B active parameters)',
  },
  'minimax.minimax-m2': {
    maxTokens: 16_384,
    ...
    outputPrice: 1.2,
    description:
      'MiniMax M2 (230B parameter MoE model with 10B active parameters)',
  },
