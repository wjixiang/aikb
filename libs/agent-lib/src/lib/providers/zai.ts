...
export const internationalZAiModels = {
  ...
  'glm-4.5-airx': {
    ...
    description:
      'GLM-4.5-AirX is a lightweight, ultra-fast variant delivering strong performance with lower cost.',
  },
  'glm-4.5-flash': {
    maxTokens: 98_304,
    contextWindow: 131_072,
    ...
    cacheReadsPrice: 0,
    description:
      'GLM-4.5-Flash is a free, high-speed model excellent for reasoning, coding, and agentic tasks.',
  },
  'glm-4.5v': {
    maxTokens: 16_384,
    contextWindow: 131_072,
  ...
  'glm-4-32b-0414-128k': {
    ...
    cacheReadsPrice: 0,
    description:
      'GLM-4-32B is a 32 billion parameter model with 128k context length, optimized for efficiency.',
  },
