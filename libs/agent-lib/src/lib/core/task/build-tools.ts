...
import type { ProviderSettings, ModeConfig, ModelInfo } from 'agent-lib/types';
import type { ClineProvider } from '../webview/ClineProvider';
import {
  getNativeTools,
  getMcpServerTools,
} from '../prompts/tools/native-tools';
import {
...
export async function buildNativeToolsArray(
  ...
  const { CodeIndexManager } = await import(
    '../../services/code-index/manager'
  );
