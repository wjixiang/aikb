...
import type { ToolUsage } from 'agent-lib/types';
...
vitest.mock('../../../integrations/terminal/TerminalRegistry', () => ({
  TerminalRegistry: {
    getOrCreateTerminal: vitest.fn().mockResolvedValue({
      ...
      getCurrentWorkingDirectory: vitest
        .fn()
        .mockReturnValue('/test/workspace'),
    }),
  },
}));
...
describe('executeCommandTool', () => {
  ...
  beforeEach(() => {
    ...
    vitest
      ...
      .mockResolvedValue([false, 'Command executed']);
    ...
    mockCline = {
      ...
      sayAndCreateMissingParamError: vitest
        .fn()
  ...
  describe('Error handling', () => {
    it('should handle missing command parameter', async () => {
      ...
      expect(
        executeCommandModule.executeCommandInTerminal,
    ...
    it('should handle rooignore validation failures', async () => {
      ...
      (formatResponse.rooIgnoreError as any).mockReturnValue(
        mockRooIgnoreError,
      );
