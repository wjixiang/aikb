...
describe('askFollowupQuestionTool', () => {
  ...
  it('should parse suggestions with mode attributes', async () => {
    const block: ToolUse = {
      ...
      params: {
        question: 'What would you like to do?',
        follow_up:
          '<suggest mode="code">Write code</suggest><suggest mode="debug">Debug issue</suggest>',
      },
      partial: false,
    };
  ...
  it('should handle mixed suggestions with and without mode attributes', async () => {
    const block: ToolUse = {
      ...
      params: {
        question: 'What would you like to do?',
        follow_up:
          '<suggest>Regular option</suggest><suggest mode="architect">Plan architecture</suggest>',
      },
      partial: false,
    };
  ...
  describe('NativeToolCallParser.createPartialToolUse for ask_followup_question', () => {
    ...
    it('should build nativeArgs with question and follow_up during streaming', () => {
      ...
      const chunk1 =
        '{"question":"What would you like?","follow_up":[{"text":"Option 1","mode":"code"}';
      const result1 = NativeToolCallParser.processStreamingChunk(
        'call_123',
        chunk1,
      );
