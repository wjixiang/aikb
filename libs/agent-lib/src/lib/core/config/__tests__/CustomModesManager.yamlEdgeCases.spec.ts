...
describe('CustomModesManager - YAML Edge Cases', () => {
  ...
  - slug: "test-mode"
    ...
    groups: ["read"]`;
      ...
      expect(modes[0].roleDefinition).toBe(
        'Test role with non-breaking spaces',
      );
    });
        ...
        customModes: [
          {
            ...
            name: 'Test Mode',
            roleDefinition:
              'Test role with \u2018fancy\u2019 quotes and \u201Ccurly\u201D quotes',
            groups: ['read'],
          },
        ],
      });
    ...
    it('should handle invalid fileRegex syntax with clear error', async () => {
	 ...
	 - slug: "test-mode"
      ...
      expect(vscode.window.showErrorMessage).toHaveBeenCalledWith(
        'customModes.errors.yamlParseError',
      );
    });
  });
  ...
  describe('Error messages', () => {
    ...
    it('should provide schema validation error messages', async () => {
      ...
      expect(modes).toHaveLength(0);
      expect(vscode.window.showErrorMessage).toHaveBeenCalledWith(
        'customModes.errors.schemaValidationError',
      );
    });
  });
        ...
        customModes: [
          {
            ...
            roleDefinition:
              'Complex role with \u201Cquotes\u201D and \u2014dashes\u2014',
            groups: [
              'read',
              [
                'edit',
