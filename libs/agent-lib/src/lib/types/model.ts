...
export type ReasoningEffortWithMinimal = z.infer<
  typeof reasoningEffortWithMinimalSchema
>;
...
export type ReasoningEffortExtended = z.infer<
  typeof reasoningEffortExtendedSchema
>;
...
export const reasoningEffortSettingSchema = z.enum(
