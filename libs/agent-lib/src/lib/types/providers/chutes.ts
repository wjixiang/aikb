...
export const chutesModels = {
  ...
  'Qwen/Qwen3-235B-A22B-Instruct-2507': {
    ...
    outputPrice: 0,
    description:
      'Qwen3 235B A22B Instruct 2507 model with 262K context window.',
  },
  'Qwen/Qwen3-235B-A22B': {
    maxTokens: 32768,
    contextWindow: 40960,
  ...
  'zai-org/GLM-4.5-turbo': {
    ...
    outputPrice: 3,
    description:
      'GLM-4.5-turbo model with 128K token context window, optimized for fast inference.',
  },
  'zai-org/GLM-4.6-FP8': {
    maxTokens: 32768,
  ...
  'zai-org/GLM-4.6-turbo': {
    ...
    outputPrice: 3.25,
    description:
      'GLM-4.6-turbo model with 200K-token context window, optimized for fast inference.',
  },
  'meituan-longcat/LongCat-Flash-Thinking-FP8': {
    maxTokens: 32768,
    contextWindow: 128000,
  ...
  'Qwen/Qwen3-Coder-480B-A35B-Instruct-FP8': {
    ...
    outputPrice: 0,
    description:
      'Qwen3 Coder 480B A35B Instruct FP8 model, optimized for coding tasks.',
  },
  'moonshotai/Kimi-K2-Instruct-75k': {
    maxTokens: 32768,
    contextWindow: 75000,
  ...
  'Qwen/Qwen3-235B-A22B-Thinking-2507': {
    ...
    description:
      'Qwen3 235B A22B Thinking 2507 model with 262K context window.',
  },
  'Qwen/Qwen3-Next-80B-A3B-Instruct': {
    maxTokens: 32768,
    contextWindow: 131072,
...
export const chutesDefaultModelInfo: ModelInfo =
  chutesModels[chutesDefaultModelId];
