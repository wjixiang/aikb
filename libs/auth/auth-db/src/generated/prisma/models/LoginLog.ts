...
export type LoginLogModel =
  runtime.Types.Result.DefaultSelection<Prisma.$LoginLogPayload>;
...
type GetLoginLogGroupByPayload<T extends LoginLogGroupByArgs> =
...
export type LoginLogWhereInput = {
  ...
  userId?: Prisma.UuidNullableFilter<'LoginLog'> | string | null;
  email?: Prisma.StringNullableFilter<'LoginLog'> | string | null;
  phone?: Prisma.StringNullableFilter<'LoginLog'> | string | null;
  loginType?: Prisma.StringFilter<'LoginLog'> | string;
  provider?: Prisma.StringNullableFilter<'LoginLog'> | string | null;
  ...
  failureReason?: Prisma.StringNullableFilter<'LoginLog'> | string | null;
...
export type LoginLogScalarWhereWithAggregatesInput = {
  ...
  userId?: Prisma.UuidNullableWithAggregatesFilter<'LoginLog'> | string | null;
  email?: Prisma.StringNullableWithAggregatesFilter<'LoginLog'> | string | null;
  phone?: Prisma.StringNullableWithAggregatesFilter<'LoginLog'> | string | null;
  loginType?: Prisma.StringWithAggregatesFilter<'LoginLog'> | string;
  provider?:
    | Prisma.StringNullableWithAggregatesFilter<'LoginLog'>
    | string
    | null;
...
export type LoginLogGetPayload<
  S extends boolean | null | undefined | LoginLogDefaultArgs,
...
> {
  [K: symbol]: {
    types: Prisma.TypeMap<ExtArgs>['model']['LoginLog'];
    meta: { name: 'LoginLog' };
  };
  /**
  ...
  >(
    args: Prisma.SubsetIntersection<T, LoginLogGroupByArgs, OrderByArg> &
      InputErrors,
  ): {} extends InputErrors
    ? GetLoginLogGroupByPayload<T>
...
export interface LoginLogFieldRefs {
  ...
  readonly phone: Prisma.FieldRef<'LoginLog', 'String'>;
  readonly loginType: Prisma.FieldRef<'LoginLog', 'String'>;
  readonly provider: Prisma.FieldRef<'LoginLog', 'String'>;
  ...
  readonly failureReason: Prisma.FieldRef<'LoginLog', 'String'>;
...
> = {
   ...
   */
  data: Prisma.XOR<
    Prisma.LoginLogCreateInput,
    Prisma.LoginLogUncheckedCreateInput
  >;
};
...
> = {
   ...
   */
  data: Prisma.XOR<
    Prisma.LoginLogUpdateInput,
    Prisma.LoginLogUncheckedUpdateInput
  >;
  /**
...
> = {
  ...
  data: Prisma.XOR<
    ...
    Prisma.LoginLogUncheckedUpdateManyInput
  >;
  /**
