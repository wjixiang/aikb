...
from lib.s3_key_generator import generate_csv_key
...
@router.post(
    ...
    支持 RFC 4180 标准的 CSV 格式。
    """,
    operation_id="createCsvFile",
    responses={
        status.HTTP_200_OK: {
            "description": "文件创建成功",
...
async def create_csv_file(
    ...
    Example:
        ...
        ```
    """
    s3_key = generate_csv_key(request.fileName)
