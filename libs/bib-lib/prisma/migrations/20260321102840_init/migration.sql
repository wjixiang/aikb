...
-- CreateIndex
CREATE UNIQUE INDEX "MeshHeading_articleId_descriptorName_qualifierName_key" ON "MeshHeading"("articleId", "descriptorName", "qualifierName");
...
-- CreateIndex
CREATE UNIQUE INDEX "Chemical_articleId_registryNumber_nameOfSubstance_key" ON "Chemical"("articleId", "registryNumber", "nameOfSubstance");
...
-- CreateIndex
CREATE UNIQUE INDEX "Grant_articleId_grantId_agency_country_key" ON "Grant"("articleId", "grantId", "agency", "country");
...
-- CreateIndex
CREATE UNIQUE INDEX "ArticleId_articleId_doi_pii_pmc_key" ON "ArticleId"("articleId", "doi", "pii", "pmc");

-- CreateIndex
CREATE INDEX "ArticleEmbedding_articleId_idx" ON "ArticleEmbedding"("articleId");

-- CreateIndex
CREATE INDEX "ArticleEmbedding_provider_model_idx" ON "ArticleEmbedding"("provider", "model");

-- CreateIndex
CREATE UNIQUE INDEX "ArticleEmbedding_articleId_provider_model_key" ON "ArticleEmbedding"("articleId", "provider", "model");
