...
/**
 * Bookshelf Components Module
 *
 * This module provides components for book library viewing and semantic search.
 */

export { BookViewerComponent, WorkspaceInfoComponent } from './bookshelfComponents.js'

/**
 * Knowledge Management Component Module
 *
 * This module provides document management with semantic search.
 */
