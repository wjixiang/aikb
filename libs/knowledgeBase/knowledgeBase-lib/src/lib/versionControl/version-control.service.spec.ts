...
describe('GitVersionControlService', () => {
    ...
    describe('Repository Management', () => {
        ...
        it('should throw error when initializing existing repository', async () => {
            ...
            await expect(service.initRepository('test-repo'))
                .rejects.toThrow('Repository test-repo already exists');
        });
    ...
    describe('Commit Management', () => {
        ...
        it('should compare commits', async () => {
            ...
            const diff = await service.compareCommits('test-repo', commit1.objectId, commit2.objectId);
    ...
    describe('Error Handling', () => {
        it('should throw error for non-existent repository', async () => {
            await expect(service.getBranches('non-existent-repo'))
        ...
        it('should throw error for non-existent branch', async () => {
            ...
            await expect(service.getBranch('test-repo', 'non-existent-branch'))
        ...
        it('should throw error for non-existent commit', async () => {
            ...
            const result = await service.getCommit('test-repo', 'non-existent-commit');
