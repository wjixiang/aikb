...
// Mock quiz data
const mockQuizzes: QuizType.QuizWithUserAnswer[] = [
  {
    _id: "1",
    type: "A1",
    class: "内科",
...
// Mock functions
const mockOnAnswerChange = async (quizId: string, answer: QuizType.answerType) => {
  console.log(`Answer changed for quiz ${quizId}:`, answer);
  return Promise.resolve();
};

const mockSetQuizSet = (
  quizSet: React.SetStateAction<QuizType.QuizWithUserAnswer[]>,
) => {
