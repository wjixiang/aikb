...
describe('BaseOpenAiCompatibleProvider', () => {
          ...
          [Symbol.asyncIterator]: () => ({
            next: vi
              ...
              .mockResolvedValueOnce({
                ...
                value: {
                  choices: [
                    { delta: { content: '<think>Complete thought</think>' } },
                  ],
                },
              })
              .mockResolvedValueOnce({
          ...
          [Symbol.asyncIterator]: () => ({
            next: vi
              ...
              .mockResolvedValueOnce({
                ...
                value: {
                  choices: [
                    { delta: { content: '<think>Incomplete thought' } },
                  ],
                },
              })
              .mockResolvedValueOnce({ done: true }),
      ...
      expect(
        chunks.some(
          (c) =>
            ...
            c.text.includes('Incomplete thought'),
        ),
      ).toBe(true);
    });
  ...
  describe('reasoning_content field', () => {
          ...
          [Symbol.asyncIterator]: () => ({
            next: vi
              ...
              .mockResolvedValueOnce({
                ...
                value: {
                  choices: [
                    { delta: { reasoning_content: 'Thinking step 2' } },
                  ],
                },
              })
              .mockResolvedValueOnce({ done: true }),
    ...
    it('should handle reasoning_content with leading/trailing whitespace', async () => {
          ...
          [Symbol.asyncIterator]: () => ({
            next: vi
              ...
              .mockResolvedValueOnce({
                ...
                value: {
                  choices: [
                    { delta: { reasoning_content: '  content with spaces  ' } },
                  ],
                },
              })
              .mockResolvedValueOnce({ done: true }),
      ...
      expect(chunks).toEqual([
        { type: 'reasoning', text: '  content with spaces  ' },
      ]);
    });
  });
