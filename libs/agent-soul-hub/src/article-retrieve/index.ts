...
- _(下文为了公式简洁，将上述集合简称为 [DISC_CORE])_
...
1. **设立时间限制（Time Filters）：** 将检索时间限制在 **近5年（2019-2024）** 内的高质量文献，重点阅读 *The Lancet, NEJM, Nature Reviews Rheumatology, Spine, The Spine Journal* 上的大综述和RCT。
