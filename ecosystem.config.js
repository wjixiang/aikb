...
module.exports = {
  apps : [{
    ...
    script : "tsx ./lib/rabbitmq/pdf-analysis.worker.ts",
  ...
  },
 {
    ...
    script: 'tsx ./lib/rabbitmq/pdf-processing-coordinator.worker.ts',
  ...
  },
  {
    ...
    script: 'tsx ./lib/rabbitmq/pdf-conversion.worker.ts',
  ...
  },
  {
    ...
    script: 'tsx ./lib/rabbitmq/markdown-storage.worker.ts',
  ...
  },
  {
    ...
    script: "tsx ./lib/rabbitmq/chunking-embedding.worker",
  ...
  },
  {
    ...
    script: "tsx ./lib/rabbitmq/markdown-part-storage.worker",
  ...
  },
  {
    ...
    script: 'tsx ./lib/rabbitmq/pdf-merger.worker.ts',
