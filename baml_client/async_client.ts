    ...
    env?: Record<string, string | undefined>
      tags?: Record<string, string>
        ...
        __baml_options__?: BamlCallOptions<never>
          ...
          // Check if onTick is provided - route through streaming if so
          if (options.onTick) {
          const stream = this.stream.Research(
          arg,
          __baml_options__
          );
          ...
          const env: Record<string, string> = Object.fromEntries(
            ...
            __baml_options__?: BamlCallOptions<never>
              ...
              const env: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.EntityExtractResult, types.EntityExtractResult>(
                  raw,
            ...
            main_entity: string,text: string,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.ScopeExtractResult[], types.ScopeExtractResult[]>
              {
              try {
              const options = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const signal = options.signal;
              ...
              console.error("Error in onTick callback for ExtractScopes", error);
              }
              }
              };
              }
              ...
              const env: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.ScopeExtractResult[], types.ScopeExtractResult[]>(
                  raw,
            ...
            query: string,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.WikiSearchParamsBaml, types.WikiSearchParamsBaml>
              {
              try {
              const options = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const signal = options.signal;
              ...
              console.error("Error in onTick callback for GenerateWikiSearchPattern", error);
              }
              }
              };
              }
              ...
              const env: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.WikiSearchParamsBaml, types.WikiSearchParamsBaml>(
                  raw,
            ...
            entity_name: string,desc_information: string,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.Entity_Plain_Definition, types.Entity_Plain_Definition>
              {
              try {
              const options = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const signal = options.signal;
              ...
              console.error("Error in onTick callback for Generate_plain_definition", error);
              }
              }
              };
              }
              ...
              const env: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.Entity_Plain_Definition, types.Entity_Plain_Definition>(
                  raw,
            ...
            __baml_options__?: BamlCallOptions<never>
              ...
              console.error("Error in onTick callback for SummarizeWikiResults", error);
              }
              }
              };
              }
