...
export async function uploadToS3(
  ...
  console.log(
    `[MockS3Service] Mock uploading: bucket=mock-bucket, key=${fileName}, contentType=${contentType}`,
  );
...
export async function getSignedUploadUrl(
  ...
  console.log(
    `[MockS3Service] Mock generating signed URL: key=${s3Key}, expiresIn=${expiresIn}`,
  );
