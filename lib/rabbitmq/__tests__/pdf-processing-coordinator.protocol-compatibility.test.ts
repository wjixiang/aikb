...
describe('PdfProcessingCoordinator Protocol Compatibility', () => {
  ...
  describe('Handler Methods', () => {
    ...
    describe('use amqp', () => {
      ...
      it('should handle analysis completed message', async () => {
        ...
        const handleAnalysisCompletedSpy = vi
          .spyOn(worker, 'handleAnalysisCompleted')
        ...
        expect(handleAnalysisCompletedSpy).toBeCalledWith(
          testMessage,
          expect.anything(),
        );
      ...
      it('should handle analysis failed message', async () => {
        ...
        const handleAnalysisFailedSpy = vi
          .spyOn(worker, 'handleAnalysisFailed')
          .mockImplementation(async () => {});
        ...
        expect(handleAnalysisFailedSpy).toBeCalledWith(
          testMessage,
          expect.anything(),
        );
      ...
      it('should handle conversion completed message', async () => {
        ...
        const handleConversionCompletedSpy = vi
          .spyOn(worker, 'handleConversionCompleted')
          .mockImplementation(async () => {});
        ...
        expect(handleConversionCompletedSpy).toBeCalledWith(
          testMessage,
          expect.anything(),
        );
      ...
      it('should handle conversion failed message', async () => {
        ...
        const handleConversionFailedSpy = vi
          .spyOn(worker, 'handleConversionFailed')
          .mockImplementation(async () => {});
        ...
        expect(handleConversionFailedSpy).toBeCalledWith(
          testMessage,
          expect.anything(),
        );
      ...
      it('should handle conversion progress message', async () => {
        ...
        const handleConversionProgressSpy = vi
          .spyOn(worker, 'handleConversionProgress')
          .mockImplementation(async () => {});
        ...
        expect(handleConversionProgressSpy).toBeCalledWith(
          testMessage,
          expect.anything(),
        );
      ...
      it('should handle markdown storage completed message', async () => {
        ...
        const handleMarkdownStorageCompletedSpy = vi
          .spyOn(worker, 'handleMarkdownStorageCompleted')
          .mockImplementation(async () => {});
        ...
        expect(handleMarkdownStorageCompletedSpy).toBeCalledWith(
          testMessage,
          expect.anything(),
        );
      ...
      it('should handle markdown storage failed message', async () => {
        ...
        const handleMarkdownStorageFailedSpy = vi
          .spyOn(worker, 'handleMarkdownStorageFailed')
          .mockImplementation(async () => {});
        ...
        expect(handleMarkdownStorageFailedSpy).toBeCalledWith(
          testMessage,
          expect.anything(),
        );
      ...
      it('should handle markdown part storage completed message', async () => {
        ...
        const handleMarkdownPartStorageCompletedSpy = vi
          .spyOn(worker, 'handleMarkdownPartStorageCompleted')
          .mockImplementation(async () => {});
        ...
        expect(handleMarkdownPartStorageCompletedSpy).toBeCalledWith(
          testMessage,
          expect.anything(),
        );
      ...
      it('should handle markdown part storage failed message', async () => {
        ...
        const handleMarkdownPartStorageFailedSpy = vi
          .spyOn(worker, 'handleMarkdownPartStorageFailed')
          .mockImplementation(async () => {});
        ...
        expect(handleMarkdownPartStorageFailedSpy).toBeCalledWith(
          testMessage,
          expect.anything(),
        );
      ...
      it('should handle markdown part storage progress message', async () => {
        ...
        const handleMarkdownPartStorageProgressSpy = vi
          .spyOn(worker, 'handleMarkdownPartStorageProgress')
          .mockImplementation(async () => {});
        ...
        expect(handleMarkdownPartStorageProgressSpy).toBeCalledWith(
          testMessage,
          expect.anything(),
        );
      ...
      it('should handle dead letter message', async () => {
        ...
        const handleDeadLetterMessageSpy = vi
          .spyOn(worker, 'handleDeadLetterMessage')
          .mockImplementation(async () => {});
        ...
        expect(handleDeadLetterMessageSpy).toBeCalledWith(
          testMessage,
          expect.anything(),
        );
    ...
    describe('use stomp', () => {
      ...
      it('should handle markdown storage completed message', async () => {
        ...
        console.log(
          `Worker stats for STOMP markdown storage completed test:`,
          stats,
        );
  ...
  describe('Error Handling', () => {
    it('should handle handler errors gracefully', async () => {
      ...
      vi.spyOn(worker, 'handleAnalysisCompleted').mockImplementation(
        async () => {
      ...
      await expect(
        worker.handleAnalysisCompleted(testMessage, {}),
