...
import { AbstractEntityContentStorage, AbstractEntityGraphStorage, AbstractEntityVectorStorage } from "./abstract-storage";
...
export default class EntityStorage extends AbstractEntityStorage {
    ...
    constructor(entityContentStorage: AbstractEntityContentStorage, entityGraphStorage: AbstractEntityGraphStorage, entityVectorStorage: AbstractEntityVectorStorage){
        super()
    ...
    async create_new_entity(entity: EntityData): Promise<EntityDataWithId> {
        return await this.entityContentStorage.create_new_entity_content(entity, AbstractEntityStorage.generate_entity_id())
    }
