...
def load_data(
    ...
    olink_lf = scan_table(exposure_table).with_columns(pl.col("eid").cast(pl.String))
...
def batch_logistic(
    ...
    Results are written to a shared flat table indexed by analysis_id.
    """
